...
export default function MonthlyViewScreen() {
  ...
  const isInSelectedMonth = (expenseDate: string, targetDate: Date): boolean => {
  ...
  const monthlyExpenses = expenses.filter((exp) => isInSelectedMonth(exp.date, selectedDate));
    ...
    <View style={styles.container}>
      ...
      <Animated.View entering={FadeIn.duration(400)} style={styles.header}>
        ...
        <View style={styles.totalContainer}>
          <Text style={styles.totalLabel}>Total for this month:</Text>
